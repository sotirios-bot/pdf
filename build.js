...
const config = {
  ...
  pages: [
    ...
    { id: "jpgToPdf", template: "converter.html", type: "converter", endpoint: "/api/image-to-pdf", ext: "pdf", downloadEvent: "jpg_to_pdf_download", inputAccept: "image/jpeg,.jpg,.jpeg", acceptExt: "jpe?g", locales: ["en", "uz", "kk"] },
